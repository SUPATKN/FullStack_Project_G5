...
=======
            ...
            <div className="overflow-hidden border shadow-md bg-white bg-opacity-10 border-black">
              <table className="table-auto mx-auto w-[1100px] border-collapse border-black">
                <thead>
                  <tr className="text-center">
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-normal letter-spacing-0-7px text-[#ff8833] w-[275px]  whitespace-nowrap rounded-tl-[8px]">
                      ID
                    </th>
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-normal letter-spacing-0-7px text-[#ff8833] w-[275px] whitespace-nowrap ">
                      Username
                    </th>
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-normal letter-spacing-0-7px text-[#ff8833] w-[275px] whitespace-nowrap ">
                      Email
                    </th>
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-normal letter-spacing-0-7px text-[#ff8833] w-[275px] whitespace-nowrap rounded-tr-lg">
                      Actions
>>>>>>> Stashed changes
                    </th>
                  </tr>
                  ...
                  {users.map((user) => (
                    <tr key={user.id} className="text-center">
                      ...
                      <td className="border-black px-2 py-3 text-[16px] font-normal letter-spacing-0-7px text-white w-[275px]  whitespace-nowrap rounded-tr-lg">
                        <button
                          className="bg-[#ff8833] text-white w-[fit-content] h-[fit-content] rounded-md p-2 px-3 hover:bg-orange-500"
                          onClick={() =>
                            handleShowTransactions(user.id, user.username)
>>>>>>> Stashed changes
                          }
