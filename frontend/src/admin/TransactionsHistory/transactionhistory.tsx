              ...
              <table className="table-auto mx-auto w-[1100px] border-collapse border-black">
                <thead>
                  <tr className="text-center">
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-bold text-[#ff8833]  whitespace-nowrap rounded-tl-[8px]">
                      ID
                    </th>
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-bold text-[#ff8833] whitespace-nowrap ">
                      Username
                    </th>
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-bold text-[#ff8833] whitespace-nowrap ">
                      Email
                    </th>
                    <th className="border-2 border-[#ff8833] px-2 py-3 text-[16px] font-bold text-[#ff8833] whitespace-nowrap rounded-tr-lg">
                      Actions
                    </th>
                  </tr>
                </thead>
