...
const PhotoDetail = () => {
  ...
  const handleClickLike = () => {
    if (currentUser && photo) {
      ...
      console.warn("User is not currently logged in. Like functionality unavailable.");
    }
  };
    ...
    <LoadingWrapper>
      <Layout>
        <div className="flex items-center flex-col justify-center text-center ">
          <h3 className="mt-3 mb-4 text-center text-[#ff8833] font-light letter-spacing-0-7px">PHOTO DETAIL</h3>
            ...
            {loading ? (
              ...
              <div className="text-center">
                <div className="flex items-center justify-between mt-3 text-center">
                  ...
                  <h3 className="text-[28px] text-center font-normal flex justify-center items-center ">{photo.title}
                  </h3>
                  <Link
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#ff8833]">
                ...
                <div className="flex items-center justify-start gap-[10px]">
                  {currentUser ? (
                    ...
                    <svg 
                      ...
                      stroke-width="1.5" 
                      stroke="currentColor" 
                      className={`size-7 HeartLike ${isClicked ? 'filled' : ''}`}
                      fill="none"
                  ...
                  {currentUser ? (
                        ...
                        <>
                          ...
                          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-md shadow-lg z-20 w-[90%] max-w-md">
                            <div className="flex items-center justify-between mb-4">
                              <h2 className="text-[26px] font-normal leading-tight mb-0 flex align-center gap-3">Comment <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.4" stroke="currentColor" class="size-7 mt-[3px]">
                    ...
                    <p className="text-danger mb-0 flex items-center gap-1 border-2 border-red-600 rounded-md p-2"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
                  </svg>
                  Log in to comment and like.</p>
                  )}
                  ...
                  {photo.max_sales === 0 && !hasPurchased ? (
                    ...
                    !hasPurchased ? (
                    currentUser ? (
                      <Button className="btnDownload flex items-center flex-row gap-1" onClick={handlePurchase}>
                        Buy for {photo.price} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                      <path d="M10.464 8.746c.227-.18.497-.311.786-.394v2.795a2.252 2.252 0 0 1-.786-.393c-.394-.313-.546-.681-.546-1.004 0-.323.152-.691.546-1.004ZM12.75 15.662v-2.824c.347.085.664.228.921.421.427.32.579.686.579.991 0 .305-.152.671-.579.991a2.534 2.534 0 0 1-.921.42Z" />
                      <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v.816a3.836 3.836 0 0 0-1.72.756c-.712.566-1.112 1.35-1.112 2.178 0 .829.4 1.612 1.113 2.178.502.4 1.102.647 1.719.756v2.978a2.536 2.536 0 0 1-.921-.421l-.879-.66a.75.75 0 0 0-.9 1.2l.879.66c.533.4 1.169.645 1.821.75V18a.75.75 0 0 0 1.5 0v-.81a4.124 4.124 0 0 0 1.821-.749c.745-.559 1.179-1.344 1.179-2.191 0-.847-.434-1.632-1.179-2.191a4.122 4.122 0 0 0-1.821-.75V8.354c.29.082.559.213.786.393l.415.33a.75.75 0 0 0 .933-1.175l-.415-.33a3.836 3.836 0 0 0-1.719-.755V6Z" clip-rule="evenodd" />
                    </svg>
                  ...
                  {(commentMap[photo.id.toString()] || []).map((comment) => (
                    ...
                    >
                      <p className="text-[14px] letter-spacing mb-0 flex flex-wrap">
                        {" "}
                        {getUsername(comment.user_id)} : {comment.content.slice(0, 50)}
